...
def get_reporting_summary_repository(db: Session = Depends(get_db)) -> ReportingSummaryRepositoryImpl:
    return ReportingSummaryRepositoryImpl(session=db)

def get_reporting_summary_service(repo: ReportingSummaryRepositoryImpl = Depends(get_reporting_summary_repository)) -> ReportingSummaryService:
    return ReportingSummaryService(repository=repo)

def get_reporting_summary_controller(service: ReportingSummaryService = Depends(get_reporting_summary_service)) -> ReportingSummaryController:
